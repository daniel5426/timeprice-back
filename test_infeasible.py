...
# This configuration should be infeasible: 
# - 2 shifts requiring 1 Manager each on the same day
# - Only 1 Manager available
# - maxShiftsPerDay = 1 (employee can only work 1 shift per day)
infeasible_test_config = {
    "employees": [
        {
            "id": "emp-1",
            "name": "John Doe",
    ...
    "constraints": {
        ...
        "maxShiftsPerDay": 1,  # This makes it infeasible
